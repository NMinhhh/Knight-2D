...
public class Boss1 : Entity
{
    ...
    protected override void Start()
    {
        ...
        MoveState = new Boss1_MoveState(this, stateMachine, "idle", moveData, this);
        SpawnState = new Boss1_SpawnState(this, stateMachine, "idle", spawnPoint, spawnData, this);
        DashAttackState = new Boss1_DashAttackState(this, stateMachine, "idle", dashAttackData, attackPoint, this);
        DeathState = new Boss1_DeathState(this, stateMachine, "idle", deathData, this);
    ...
    {
        base.Update();
        if (isReady == null || stateMachine.currentState == SpawnState || stateMachine.currentState == DashAttackState || isDead) return;
